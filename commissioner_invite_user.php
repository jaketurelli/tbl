...
if (isset($_POST['invite'])) {
	...
	$league_invite_code = rand(100000, 999999);
	$league_code_string = (string)$league_invite_code;
	...
	$message_html .=        'League Code: <b>' . $league_code_string . '</b></p>';
	$message_html .= '  </body>';
	$message_html .= '</html>';
...
$_SESSION['COMMISSIONER_TAB'] = 5; // invite user is fifth tab
